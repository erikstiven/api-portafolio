...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('perfil', function (Blueprint $table) {
            ...
            // API usa nombre_completo (dejamos nombre/apellido opcionales por compatibilidad)
            $table->string('nombre_completo')->nullable();

            // email opcional (la API no siempre lo envía). UNIQUE permite múltiples NULL en MySQL.
